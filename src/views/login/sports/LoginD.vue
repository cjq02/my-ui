<template>
  <div class="page">
    ...
    <img class="bg-image" src="@/assets/img/login/sports/login4-bg.png" alt="stadium background" />
    <div class="pic-box">
      <div class="pic">
        <img src="@/assets/img/login/sports/login4-pic1.png"  />
      </div>
      <div class="pic">
        <img src="@/assets/img/login/sports/login4-pic2.png"  />
      </div>
      <div class="pic">
        <img src="@/assets/img/login/sports/login4-pic3.png"  />
      </div>
      <div class="pic">
        <img src="@/assets/img/login/sports/login4-pic4.png"  />
      </div>
      <div class="pic">
        <img src="@/assets/img/login/sports/login4-pic5.png"  />
      </div>
