    ...
    <div class="inner">
      ...
      <div class="login-inner">
        <div class="login-pic">
          ...
          <div class="login-img">
            <img src="@/assets/img/login/internalControl/loginB/login-pic.png" alt="">
          </div>
        </div>
...
.login-bg {
  ...
  min-width: 900px;
  height: 100%;
   background-image: url('@/assets/img/login/internalControl/loginB/login-bg.png');
...
.login-container {
  ...
  .login-pic{
    position: relative;
    flex:1;
    //background: url('@/assets/img/login/internalControl/loginB/login-pic-bg.png') top center no-repeat;
    //background-size: 100% 100%;
    img {
